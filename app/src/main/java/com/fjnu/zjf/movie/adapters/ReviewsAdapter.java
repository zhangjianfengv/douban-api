...
public class ReviewsAdapter extends BaseAdapter {
    ...
    public ReviewsAdapter(List<Reviews.ReviewsBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_listview_fragment_reviews, null);
        ...
        viewHolder.tvContent.setText(list.get(position).getSummary());
